...
const Rebbok = ({res2}) => {
    ...
    const [ReebookShoes, setReebookShoes] = useState([]);

    const gettingData = async()=>{

        const res = await axios.get(path+"brand/reebok");
                           ...
                           return(
                               <>
                                <div className= 'card col-md-4'  >
                                    ...
                                    <div className='p-3 '  >
                                    <a href = {'/brands/' + items.product_id}>
                                        <button className='w-72 h-12 text-center text-2xl rounded-none   bg-black text-white'>View Product</button>
                                    </a>
                                    </div>
                                </div>
       ...
       <header id = "brand_fifth">
            <div className='row'>
                <div className='row px-20'>
                    ...
                    {ReebookShoes.slice(1, Visible).map((items)=>{
                           return(
                               <>
